    ...
    <div class="headview">
        <div class="row align-items-center">
            <div class="col-lg-8 col-md-7 col-sm-7 col-12">
                <h1 class="view_txt m-0">Apply Correction PAN Card</h1>
            </div>
        ...
        <div class="card">
            <div class="form-container my-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="form-group inside-bnt">
                            ...
                            <input type="text" class="form-control" name=""
                                placeholder="Enter 10-digit Customer PAN No." id="">
                            <button class="edit inner-button">Verify PAN details: Pay &#8377;5</button>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <div class="col-lg-6 col-xs-12 col-md-6  col-sm-12 col-12">
                        <div class="form-group">
