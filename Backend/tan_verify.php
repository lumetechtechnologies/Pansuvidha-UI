    ...
    <div class="headview">
        <div class="row align-items-center">
            <div class="col-lg-8 col-md-7 col-sm-7 col-12">
                <h1 class="view_txt m-0">TAN Verify</h1>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xs-12 col-md-6 ">
                        <div class="form-group">
                            <label for="">TAN Number<span>*</span></label>
                            <input type="text" class="form-control" name="" placeholder="Enter TAN Number" id="">
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <h2 class="title-modal linkaadhar">TAN Verify</h2>
                                <hr>
                            </div>
                            <div class="col-lg-6">
                                <h5>Customer Name:</h5>
