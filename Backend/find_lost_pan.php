    ...
    <div class="headview">
        <div class="row align-items-center">
            <div class="col-lg-8 col-md-7 col-sm-7 col-12">
                <h1 class="view_txt m-0">Find Lost PAN</h1>
            </div>
        ...
        <div class="card">
            <div class="form-container my-3">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xs-12 col-md-6 ">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="" placeholder="Enter 10 digit PAN Number"
                                id="">
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xs-12 col-md-6 ">
                        <div class="form-group">
                            <label for="">PAN Holder Name <span>*</span></label>
                            <input type="text" class="form-control" name="" placeholder="Enter PAN Holder Name" id="">
                        </div>
                    </div>
...
<div class="modal fade serviceverifyModal" id="serviceverifyModal" data-bs-backdrop="static" data-bs-keyboard="false"
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-12">
                        <h2 class="title-modal linkaadhar">Find Lost PAN Details</h2>
                        <hr>
                    </div>
                    <div class="col-lg-6">
                        <h5>PAN Holder Name:</h5>
                    </div>
                    <div class="col-lg-6">
                        <p>NA</p>
                    </div>
